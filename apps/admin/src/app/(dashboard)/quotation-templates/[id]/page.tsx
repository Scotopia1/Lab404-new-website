...
export default function EditTemplatePage() {
  ...
  const { data: template, isLoading: templateLoading } = useQuotationTemplate(id);
  ...
  useEffect(() => {
    if (template) {
      reset({
        ...
        defaultDiscount: template.defaultDiscount?.toString() || "",
        defaultDiscountType: template.defaultDiscountType || "percentage",
        defaultTaxRate: template.defaultTaxRate
          ? (template.defaultTaxRate * 100).toString()
          : "",
        defaultValidDays: template.defaultValidDays?.toString() || "30",
        isActive: template.isActive,
      });
      setIsActive(template.isActive);
      setTermsContent(template.defaultTerms || "");
      setLineItems(
      ...
      await updateTemplate.mutateAsync({
        ...
        data: {
          ...
          defaultDiscount: data.defaultDiscount
            ...
            : null,
          defaultDiscountType: data.defaultDiscountType || null,
          ...
          defaultValidDays: data.defaultValidDays
            ...
            : undefined,
          defaultTerms: termsContent || null,
          isActive,
        },
      });
  ...
  if (!template) {
    return (
      <div className="flex flex-col items-center justify-center h-96">
        ...
        <Button onClick={() => router.push("/quotation-templates")}>
          Back to Templates
        </Button>
      </div>
    );
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Inactive templates won't appear in the template selector
                    </p>
                  </div>
                  <Switch
                    checked={isActive}
